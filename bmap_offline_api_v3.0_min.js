...
(function() {
    ...
    //B.v&modp =bmapcfg.home;  //修改，本地工具资源引用(离线路径)
    ...
    nd.getTilesUrl = function(a, b) {       //这个函数是调用三维地图的
        var c = a.x
          , e = a.y
		...
		// tdir = tdir + "/" + b + "/" + c + "/" + e + ".jpg"; //修改 使用本地卫星的瓦片
	    // return tdir;
    ...
    od.getTilesUrl = function(a, b) {
        ...
        //说明：卫星图 只有底图，没有标注
        //改成了调用我们的瓦片的地址
        return bmapcfg.tiles_hybrid+ "/" + b + "/" + c + "/" + e + ".jpg";
    ...
    pd.getTilesUrl = function(a, b) {
        ...
        //改成了调用我们的瓦片的地址
        return bmapcfg.tiles_self+"/" + b + "/" + c + "/" + e + ".png";
    }
    ;
